...
class TaintManager {
    ...
    addPseudoTaintSender(sender) {
        ...
        console.log((_a = this._contexts.get(sender.contextFilename)) === null || _a === void 0 ? void 0 : _a.defToTaintIds.get(sender.taintDef.uniqueId));
   ...
   */
    generateResolvedKey(receiver, sender, senderTaintId) {
        ...
        const sRange = (_b = sender.astNode) === null || _b === void 0 ? void 0 : _b.range;
