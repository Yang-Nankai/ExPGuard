...
const method = (name, effect) => ({
    type: "function",
    name,
    effect: effect || name,
});
const attribute = (name, sourceType) => ({
    type: "attribute",
    name,
    sourceType,
});
const BUILTINS = [
    ...
    },
    {
        ...
        prototypeMethods: {
            ...
            set: method("URLSearchParams.prototype.set", "URLSearchParams.prototype.append"),
        ...
        props: {
            ...
            browsingData: {
                ...
                props: {
                    ...
                    removeServiceWorkers: method("chrome.browsingData.removeServiceWorkers"),
            ...
            declarativeContent: {
                ...
                props: {
                    onPageChanged: {
                        ...
                        props: {
                            addRules: method("chrome.declarativeContent.onPageChanged.addRules"),
                            removeRules: method("chrome.declarativeContent.onPageChanged.removeRules"),
                        },
                    },
                },
            },
            ...
            runtime: {
                ...
                props: {
                    ...
                    onMessageExternal: {
                        ...
                        props: {
                            addListener: method("chrome.runtime.onMessageExternal.addListener"),
                        },
                    },
                    onConnectExternal: {
                        type: "object",
                        ...
                        props: {
                            addListener: method("chrome.runtime.onConnectExternal.addListener"),
                        },
                    },
                    onConnectNative: {
                        type: "object",
                ...
                props: {
                    ...
                    display: {
                        ...
                        props: {
                            ...
                            getDisplayLayout: method("chrome.system.display.getDisplayLayout"),
                        },
                    },
                    memory: {
                        type: "object",
    ...
    },
    {
        ...
        props: {
            geolocation: {
                ...
                props: {
                    getCurrentPosition: method("navigator.geolocation.getCurrentPosition"),
            ...
            connection: {
                ...
                props: {
                    downlink: attribute("navigator.connection.downlink", "NAVIGATOR_CONNECTION"),
                    effectiveType: attribute("navigator.connection.effectiveType", "NAVIGATOR_CONNECTION"),
                    rtt: attribute("navigator.connection.rtt", "NAVIGATOR_CONNECTION"),
                },
            },
            deviceMemory: attribute("navigator.deviceMemory", "NAVIGATOR_DEVICE_MEMORY"),
            gpu: {
                type: "object",
                name: "navigator.gpu",
                props: {
            ...
            hardwareConcurrency: attribute("navigator.hardwareConcurrency", "NAVIGATOR_HARDWARE_CONCURRENCY"),
            language: attribute("navigator.language", "NAVIGATOR_LANGUAGE"),
            languages: attribute("navigator.languages", "NAVIGATOR_LANGUAGE"),
            maxTouchPoints: attribute("navigator.maxTouchPoints", "NAVIGATOR_MAX_TOUCH_POINTS"),
            ...
            userAgentData: attribute("navigator.userAgentData", "NAVIGATOR_USER_AGENT"),
                ...
                props: {
                    Hex: {
                        ...
                        props: {
                            ...
                            parse: method("CryptoJS.enc.Hex.parse", "CryptoJS.enc.Hex.stringify"),
                        },
                    },
                    Utf8: {
                        type: "object",
                        ...
                        props: {
                            stringfy: method("CryptoJS.enc.Utf8.stringify", "CryptoJS.enc.Hex.stringify"),
                            parse: method("CryptoJS.enc.Utf8.parse", "CryptoJS.enc.Hex.stringify"),
                        },
                    },
                    Base64: {
                        type: "object",
                        ...
                        props: {
                            stringfy: method("CryptoJS.enc.Base64.stringify", "CryptoJS.enc.Hex.stringify"),
                            parse: method("CryptoJS.enc.Base64.parse", "CryptoJS.enc.Hex.stringify"),
                        },
                    },
                },
            },
